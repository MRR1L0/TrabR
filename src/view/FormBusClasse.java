...
public class FormBusClasse extends javax.swing.JDialog {

    public FormBusClasse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTableBuscas.getColumnModel().getColumnCount() > 0) {
            jTableBuscas.getColumnModel().getColumn(0).setMaxWidth(50);
            jTableBuscas.getColumnModel().getColumn(1).setMaxWidth(550);
        }
