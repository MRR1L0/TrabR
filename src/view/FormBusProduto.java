...
public class FormBusProduto extends javax.swing.JFrame {

    public FormBusProduto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableBuscas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição", "Estoque", "Preço de Venda", "Status", "Marca", "Classe"
            }
        ) {
        ...
        if (jTableBuscas.getColumnModel().getColumnCount() > 0) {
            ...
            jTableBuscas.getColumnModel().getColumn(2).setMaxWidth(200);
            jTableBuscas.getColumnModel().getColumn(4).setMaxWidth(60);
        }
