 ...
 * @author aluno
 */
public class TelaBuscas extends javax.swing.JDialog {

    /**
     * Creates new form TelaBuscas
     */

    public TelaBuscas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonSair.setPreferredSize(new java.awt.Dimension(95, 25));
